...
async function startServer() {
  ...
  const enrichCatalog = (product: any) => { const { deviceProfiles, ...publicProduct } = product; return { ...publicProduct, ...(PRODUCT_DETAILS[product.slug] || {}) }; };
